...
const RatingWorks2 = () => {
  ...
  return (
    <section className="GetFontSol relative bg-[#0c2340] rounded-[40px_0_40px_0] max-w-[1200px] mx-auto px-6 py-12 md:py-16 md:px-12 overflow-hidden text-white shadow-lg">
      {/* Background */}
      <img
      ...
      <div
        ref={scrollRef}
        className="relative z-10 flex gap-6 overflow-x-auto pb-6 md:pb-8 snap-x snap-mandatory scrollbar-hide px-2"
      >
        {testimonials.map((item, index) => (
          <article
            ...
            className="bg-white text-gray-800 rounded-tl-[40px] rounded-tr-[20px] rounded-bl-[20px] rounded-br-[40px] flex-shrink-0 p-8 shadow-lg relative 
              w-[85%] sm:w-[70%] md:w-[45%] lg:w-[30%] snap-center mx-auto"
          >
