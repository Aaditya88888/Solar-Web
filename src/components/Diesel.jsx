          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <section>
              ...
              <p className=" text-gray-500">
                Our diesel and petrol gensets provide robust and
                high-performance power solutions for critical situations,
                ensuring uninterrupted electricity supply when it matters most.
                Designed to withstand challenging conditions, these gensets are
                ideal for homes, businesses, and remote locations that require
                dependable backup power. With advanced engineering and superior
                fuel efficiency, they deliver reliable energy with minimal
                operational costs.
              </p>
              <p className="mt-4 text-gray-500">
                Built for long-lasting durability, our gensets feature
                high-quality components that enhance their lifespan and
                performance. Their sturdy construction ensures consistent
                functionality, even in demanding environments where power
                stability is crucial. Whether facing extreme weather, remote
                operations, or emergency outages, our generators offer peace of
                mind by delivering power when needed.
              </p>
            </section>
