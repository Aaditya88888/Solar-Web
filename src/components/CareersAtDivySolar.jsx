  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 text-gray-800 font-inter">
      ...
      <p className="text-base leading-relaxed text-justify mb-6">
        At <strong>DIVY Solar</strong>, we are not just building solar systems —
        we’re building a sustainable future. We believe in the power of clean
        energy and the people behind it. If you’re passionate about renewable
        energy, innovation, and making a real impact, you’ve come to the right
        place.
      </p>

      {/* Why Work with DIVY */}
      <h2 className="text-xl font-semibold text-brandBlue mb-3">
        Why Work with DIVY Solar?
      </h2>
      <ul className="list-disc list-inside space-y-1 text-base leading-relaxed text-justify mb-6">
        <li>
          <strong>Purpose-Driven Work:</strong> Contribute to India’s transition
          toward a greener tomorrow.
        </li>
        <li>
          <strong>Growth Opportunities:</strong> Learn, grow, and advance in a
          fast-evolving solar industry.
        </li>
        <li>
          <strong>Innovative Culture:</strong> Work with passionate minds and
          cutting-edge technology.
        </li>
        <li>
          <strong>Inclusive Environment:</strong> We value ideas, collaboration,
          and diversity.
        </li>
      </ul>
      ...
      <p className="italic text-base text-justify mb-8">
        Didn’t find a role that suits you? Don’t worry—we’d still love to hear
        from you.
      </p>

      {/* Join DIVY */}
      <h2 className="text-xl font-semibold text-brandBlue mb-3">
        Join the DIVY Family
      </h2>
