  ...
  return (
    <div className="bg-[#f5f7fa] min-h-screen font-['Montserrat']">
      <main className="max-w-[1200px] mx-auto mt-6 px-4 sm:px-6 md:px-8">
        <div
          className="relative rounded-[30px] overflow-hidden bg-gradient-to-b from-[#7ec0f7] to-[#5aa0e7] flex flex-col md:flex-row md:items-center"
        ...
        >
          ...
          <div className="absolute top-0 left-0 bg-white rounded-tr-[30px] rounded-bl-[30px] px-4 py-3 flex items-center space-x-3 z-10 shadow-md">
            <div className="w-10 h-10 rounded-full bg-[#0a0a23] text-white font-bold text-lg flex items-center justify-center">
              1
            </div>
          ...
          <div className="absolute top-6 right-6 bg-[#0a0a23] rounded-full px-4 py-2 flex items-center space-x-2 text-white text-xs font-semibold z-10 shadow-md">
            ...
            <span className="bg-white text-[#0a0a23] rounded-full px-2 py-[2px] font-bold">
              +639-2145-251
            </span>
          </div>
          ...
          <div className="flex-1 p-8 md:p-12 max-w-lg z-10">
            <p className="text-xs text-[#1f2937] mb-1 font-semibold">
              LOREM IPSUM LOREM
            </p>
          ...
          <div className="flex-1 relative h-full min-h-[400px]">
            ...
            <div className="absolute bottom-6 right-6 bg-[#0a0a23] rounded-tl-[30px] rounded-br-[30px] p-4 flex items-center space-x-4 max-w-xs text-white shadow-lg">
              <div className="flex space-x-[-12px]">
                <img
                  src="https://storage.googleapis.com/a1aa/image/b4fa1898-5409-4176-32ec-2791881d2c2b.jpg"
                  alt="Avatar"
                  className="w-10 h-10 rounded-full border-2 border-white"
                />
                <img
                  src="https://storage.googleapis.com/a1aa/image/4d17a87f-504b-4cda-41b8-9eea0110813a.jpg"
                  alt="Avatar"
                  className="w-10 h-10 rounded-full border-2 border-white"
                />
                <img
                  src="https://storage.googleapis.com/a1aa/image/1316c84a-5d05-4569-9ae2-8dbacb3153e7.jpg"
                  alt="Avatar"
                  className="w-10 h-10 rounded-full border-2 border-white"
                />
              </div>
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-300">
                  Check out the positive feedback our customers gave us.
                </p>
              </div>
            </div>
          </div>
